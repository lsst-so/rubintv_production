...
from lsst.rubintv.production.aos import FourPanelFocalPlanePlotter
...
podDetails = PodDetails(instrument=instrument, podFlavor=PodFlavor.FOURPANELFOCALPLANE_PLOTTER,
                        detectorNumber=None, depth=0)
print(
...
fourPanelFocalPlanePlotter = FourPanelFocalPlanePlotter(
    butler=butler,
    locationConfig=locationConfig,
    instrument=instrument,
    podDetails=podDetails,
)
fourPanelFocalPlanePlotter.run()
